...
const Sports: React.FC = () => {
  ...
  if (loading) {
    return (
      <div
        className="min-h-screen bg-gray-50 dark:bg-gray-700 pt-20 px-4 sm:px-6 lg:px-8 flex items-center justify-center"
  ...
  return (
    <div
      className="min-h-screen bg-gray-50 dark:bg-gray-700 pt-20 px-4 sm:px-6 lg:px-8"
      style={{ paddingTop: "9rem" }}
    >
      ...
      <div className="max-w-3xl mx-auto mb-10 grid gap-4 md:grid-cols-2">
        <input
          ...
          className="px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
        />
        <input
          type="date"
          value={dateFilter}
          ...
          filteredEvents.map((event, idx) => (
            ...
            >
              <img
                ...
                onError={(e) => {
                  e.currentTarget.src = "/placeholder-sports.jpg"; // Fallback image
                }}
              />
              <div className="p-5">
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-center mt-4 w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors dark:bg-blue-700 dark:hover:bg-blue-800"
                >
